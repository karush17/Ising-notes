...
\begin{gather}
    2L(N-1)\underset{s_{t},a_{t}}{\textbf{E}}[\pi^{\theta}_{i}(a_{t}|s_{t})\log \pi^{\theta}_{i}(a_{t}|s_{t})] \leq 2L(N-1)\underset{s_{t},a_{t}}{\textbf{E}}[\pi^{\theta}_{*}(a_{t}|s_{t})\log \pi^{\theta}_{*}(a_{t}|s_{t})] \nonumber \label{eq:optimal}
\end{gather} 
