...
\begin{proof}
    ...
    \begin{gather}
        \leq L\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \pi^{\theta}_{i}(a_{t}|s_{t})\frac{1}{\pi^{\theta}_{i}(a_{t}|s_{t})}\nabla_{\theta}\pi^{\theta}_{i}(a_{t}|s_{t}) + \pi^{\theta}_{j}(a_{t}|s_{t})\frac{1}{\pi^{\theta}_{j}(a_{t}|s_{t})}\nabla_{\theta}\pi^{\theta}_{j}(a_{t}|s_{t})] \nonumber \\       
        = L\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \pi^{\theta}_{i}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{i}(a_{t}|s_{t}) + \pi^{\theta}_{j}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{j}(a_{t}|s_{t})] \nonumber        
    \end{gather}
    ...
    \begin{gather}
        \leq L\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \pi^{\theta}_{*}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{*}(a_{t}|s_{t}) + \pi^{\theta}_{*}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{*}(a_{t}|s_{t})] \nonumber \\
        = 2L\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \pi^{\theta}_{*}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{*}(a_{t}|s_{t})] \nonumber               
    \end{gather}
    which leads to the following bound,
    \begin{gather}
        \nabla_{\theta}\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \sigma^{\pi_{i}}\sigma^{\pi_{j}}] \leq 2L\underset{s_{t}}{\textbf{E}}[\sum_{i,j} \pi^{\theta}_{*}(a_{t}|s_{t})\nabla_{\theta}\log\pi^{\theta}_{*}(a_{t}|s_{t})] \label{eq:bound}               
    \end{gather}
    Thus,
    \begin{gather}
        \nabla_{\theta}J(\theta) \leq \underset{s_{t},a_{t}}{\textbf{E}}[\nabla_{\theta}(\log \pi^{\theta}_{i}(a_{t}|s_{t})(Q^{\pi}(s_{t},a_{t}) + b^{\theta}(s_{t})) + 2L\underset{s_{t},a_{t}}{\textbf{E}}[\pi^{\theta}_{*}(a_{t}|s_{t})\log \pi^{\theta}_{*}(a_{t}|s_{t})] \nonumber
